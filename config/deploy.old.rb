...
set :domain, '33.33.13.39' # -jw: if deploying to a real server, 
...
#   set :port, '30000'     # SSH port number.
	set :term_mode, nil #fixes password prompt hanging
...
task :environment do
  ...
  invoke :'rvm:use[ruby-1.9.3-p448@default]'
	#invoke : 'rvm:use[source /etc/profile.d/rvm.sh]'
#invoke : 'rvm:use[source /usr/local/rvm/scripts/rvm]'
end
